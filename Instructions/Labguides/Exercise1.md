...
5. Once the **Project_Nexus_survey_results.xlsx** is added, in the prompt field, enter the following prompt **(1)** and then click on the arrow icon **Send (2)**:
